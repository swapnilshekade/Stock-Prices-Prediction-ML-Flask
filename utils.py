...
def read_all_stock_files(individual_stocks_5yr):
    allFiles = []
    for (_, _, files) in os.walk('C:/Users/shekade/Downloads/ml_dashboard/Stock-Prices-Prediction-ML-Flask-Dashboard-master/individual_stocks_5yr/.'):
        allFiles.extend(files)
        break

    dataframe_dict = {}
    for stock_file in allFiles:
        df = pd.read_csv('C:/Users/shekade/Downloads/ml_dashboard/Stock-Prices-Prediction-ML-Flask-Dashboard-master/individual_stocks_5yr/.' + "/" +stock_file)
